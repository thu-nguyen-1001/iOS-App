...
/*
    override func numberOfSections (in tableView: UITableView) -> Int {
        return 1 //exact number to be determined later
    }
 */
    ...
    */
    ...
    func tableView(tableView: UITableView, didSelectRowAt indexPath: IndexPath){ performSegue(withIdentifier: "ToDetailSegue", sender: self)
    }
    override func prepare (for segue: UIStoryboardSegue, sender: Any?){ if segue.identifier == "ToDetailSegue" {
